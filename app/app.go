...
import (
	...
	_ "github.com/xtelabs/xtechain/client/docs/statik"
	...
	"github.com/xtelabs/xtechain/x/evm"
	evmkeeper "github.com/xtelabs/xtechain/x/evm/keeper"
	evmtypes "github.com/xtelabs/xtechain/x/evm/types"
	"github.com/xtelabs/xtechain/x/evm/vm/geth"
	"github.com/xtelabs/xtechain/x/feemarket"
	feemarketkeeper "github.com/xtelabs/xtechain/x/feemarket/keeper"
	feemarkettypes "github.com/xtelabs/xtechain/x/feemarket/types"
...
// var _ server.Application (*XteApp)(nil)

// XteApp implements an extended ABCI application. It is an application
...
func NewXteApp(
	...
	// use custom Xte account for contracts
...
// use Xte's custom AnteHandler
func (app *XteApp) setAnteHandler(txConfig client.TxConfig, maxGasWanted uint64) {
	anteHandler, err := ante.NewAnteHandler(ante.HandlerOptions{
		...
		ExtensionOptionChecker: xte.HasDynamicFeeExtensionOption,
...
func (app *XteApp) setPostHandler() {
...
func (app *XteApp) Name() string { return app.BaseApp.Name() }
