...
import (
	...
	"github.com/xtelabs/xtechain/testutil"
	utiltx "github.com/xtelabs/xtechain/testutil/tx"
	...
	ante "github.com/xtelabs/xtechain/app/ante"
	"github.com/xtelabs/xtechain/encoding"
	"github.com/xtelabs/xtechain/tests"
	"github.com/xtelabs/xtechain/x/evm/statedb"
...
func (suite *AnteTestSuite) SetupTest() {
	...
	suite.app = app.Setup(checkTx, func(app *app.XteApp, genesis simapp.GenesisState) simapp.GenesisState {
...
func (suite *AnteTestSuite) createBaseTxBuilder(msg sdk.Msg, gas uint64) client.TxBuilder {
	...
	txBuilder.SetFeeAmount(sdk.NewCoins(
		sdk.NewCoin("axte", sdk.NewInt(10000)),
	))
