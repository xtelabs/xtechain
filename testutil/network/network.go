...
func DefaultConfig() Config {
	...
	return Config{
		...
		ChainID:           fmt.Sprintf("xtechain_%d-1", tmrand.Int63n(9999999999999)+1),
		NumValidators:     4,
		BondDenom:         xte.AttoPhoton,
		MinGasPrices:      fmt.Sprintf("0.000006%s", xte.AttoPhoton),
		AccountTokens:     sdk.TokensFromConsensusPower(1000, xte.PowerReduction),
		StakingTokens:     sdk.TokensFromConsensusPower(500, xte.PowerReduction),
		BondedTokens:      sdk.TokensFromConsensusPower(100, xte.PowerReduction),
...
func New(l Logger, baseDir string, cfg Config) (*Network, error) {
	...
	if !xte.IsValidChainID(cfg.ChainID) {
	...
	for i := 0; i < cfg.NumValidators; i++ {
		...
		customAppTemplate, _ := config.AppConfig(xte.AttoPhoton)
