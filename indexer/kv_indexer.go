...
var _ xte.EVMTxIndexer = &KVIndexer{}
...
func (kv *KVIndexer) GetByTxHash(hash common.Hash) (*xte.TxResult, error) {
...
func (kv *KVIndexer) GetByBlockAndIndex(blockNumber int64, txIndex int32) (*xte.TxResult, error) {
...
func isEthTx(tx sdk.Tx) bool {
	...
	if len(opts) != 1 || opts[0].GetTypeUrl() != "/xte.evm.v1.ExtensionOptionsEthereumTx" {
		return false
	}
	return true
}
...
func saveTxResult(codec codec.Codec, batch dbm.Batch, txHash common.Hash, txResult *xte.TxResult) error {
