...
def test_native_tx_priority(xtechain):
    cli = xtechain.cosmos_cli()
    ...
    test_cases = [
        {
            ...
            "amount": "1000axte",
            "gas_prices": f"{base_fee + PRIORITY_REDUCTION * 600000}axte",
        ...
        },
        {
            ...
            "amount": "1000axte",
            "gas_prices": f"{base_fee + PRIORITY_REDUCTION * 400000}axte",
    ...
    for tc in test_cases:
        ...
        gas_price = int(tc["gas_prices"].removesuffix("axte"))
