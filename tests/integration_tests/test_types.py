...
def test_block(xtechain, geth):
    get_blocks(xtechain, geth, False)
    get_blocks(xtechain, geth, True)


def get_blocks(xtechain_rpc_ws, geth, with_transactions):
    w3: Web3 = xtechain_rpc_ws.w3
    eth_rpc = w3.provider
    ...
    xtechain_blk = w3.eth.get_block(1)
    # Get existing block, no transactions
    eth_rsp = eth_rpc.make_request(
        "eth_getBlockByHash", [xtechain_blk["hash"].hex(), with_transactions]
    )
...
def test_accounts(xtechain_rpc_ws, geth):
    w3: Web3 = xtechain_rpc_ws.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
...
def test_syncing(xtechain_rpc_ws, geth):
    w3: Web3 = xtechain_rpc_ws.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
...
def test_coinbase(xtechain_rpc_ws, geth):
    w3: Web3 = xtechain_rpc_ws.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
...
def test_max_priority_fee(xtechain_rpc_ws, geth):
    w3: Web3 = xtechain_rpc_ws.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
...
def test_gas_price(xtechain_rpc_ws, geth):
    w3: Web3 = xtechain_rpc_ws.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
...
def test_block_number(xtechain_rpc_ws, geth):
    w3: Web3 = xtechain_rpc_ws.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
...
def test_balance(xtechain_rpc_ws, geth):
    w3: Web3 = xtechain_rpc_ws.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
    make_same_rpc_calls(
...
def test_get_storage_at(xtechain_rpc_ws, geth):
    w3: Web3 = xtechain_rpc_ws.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
    make_same_rpc_calls(
...
def test_get_proof(xtechain_rpc_ws, geth):
    # on xtechain the proof query will fail for block numbers <= 2
...
def test_get_code(xtechain_rpc_ws, geth):
    w3: Web3 = xtechain_rpc_ws.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
    make_same_rpc_calls(
...
def test_get_block_transaction_count(xtechain_rpc_ws, geth):
    w3: Web3 = xtechain_rpc_ws.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
    make_same_rpc_calls(
...
def test_get_transaction(xtechain_rpc_ws, geth):
    w3: Web3 = xtechain_rpc_ws.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
    make_same_rpc_calls(
...
def test_get_transaction_receipt(xtechain_rpc_ws, geth):
    w3: Web3 = xtechain_rpc_ws.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
    make_same_rpc_calls(
...
def test_fee_history(xtechain_rpc_ws, geth):
    w3: Web3 = xtechain_rpc_ws.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
...
def test_estimate_gas(xtechain_rpc_ws, geth):
...
def test_incomplete_send_transaction(xtechain_rpc_ws, geth):
