...
// transactions. There should only be a single implementation in xtechain. For
// the purposes of xtechain, it should be support retrieving headers and
// consensus parameters from  the current blockchain to be used during
// transaction processing.
//
// NOTE: xtechain will distribute the fees out to validators, so the structure
