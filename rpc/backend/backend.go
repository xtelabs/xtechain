...
type EVMBackend interface {
	...
	GetTxByEthHash(txHash common.Hash) (*xte.TxResult, error)
	GetTxByTxIndex(height int64, txIndex uint) (*xte.TxResult, error)
...
func NewBackend(
	...
	chainID, err := xte.ParseChainID(clientCtx.ChainID)
	if err != nil {
		panic(err)
	}
