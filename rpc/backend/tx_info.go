...
func (b *Backend) GetTxByEthHash(hash common.Hash) (*xte.TxResult, error) {
	if b.indexer != nil {
...
func (b *Backend) queryTendermintTxIndexer(query string, txGetter func(*rpctypes.ParsedTxs) *rpctypes.ParsedTx) (*xte.TxResult, error) {
