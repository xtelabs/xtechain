...
import (
	...
	"github.com/xtelabs/xtechain/rpc/backend"
	"github.com/xtelabs/xtechain/rpc/namespaces/ethereum/debug"
	"github.com/xtelabs/xtechain/rpc/namespaces/ethereum/eth"
	"github.com/xtelabs/xtechain/rpc/namespaces/ethereum/eth/filters"
	"github.com/xtelabs/xtechain/rpc/namespaces/ethereum/miner"
	"github.com/xtelabs/xtechain/rpc/namespaces/ethereum/net"
	"github.com/xtelabs/xtechain/rpc/namespaces/ethereum/personal"
	"github.com/xtelabs/xtechain/rpc/namespaces/ethereum/txpool"
	"github.com/xtelabs/xtechain/rpc/namespaces/ethereum/web3"
...
func init() {
	apiCreators = map[string]APICreator{
		...
		Web3Namespace: func(*server.Context, client.Context, *rpcclient.WSClient, bool, xte.EVMTxIndexer) []rpc.API {
			return []rpc.API{
				{
		...
		NetNamespace: func(_ *server.Context, clientCtx client.Context, _ *rpcclient.WSClient, _ bool, _ xte.EVMTxIndexer) []rpc.API {
			return []rpc.API{
				{
		...
		TxPoolNamespace: func(ctx *server.Context, _ client.Context, _ *rpcclient.WSClient, _ bool, _ xte.EVMTxIndexer) []rpc.API {
			return []rpc.API{
				{
