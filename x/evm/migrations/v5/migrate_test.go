...
import (
	...
	v5 "github.com/xtelabs/xtechain/x/evm/migrations/v5"
	v5types "github.com/xtelabs/xtechain/x/evm/migrations/v5/types"
...
func TestMigrate(t *testing.T) {
	...
	kvStore.Set(types.ParamStoreKeyEVMDenom, []byte("axte"))
	...
	require.Equal(t, "axte", params.EvmDenom)
